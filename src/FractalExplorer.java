...
/**
 * Класс интерфейса для отображения фракталов
 */
public class FractalExplorer {
    ...
    private JComboBox<FractalGenerator> jComboBox;//комбобокс сверху
    private JButton resetButton;//кнопка сброса
    ...
    private void createAndShowGUI() {
        ...
        // Настройки для вывода на окне кнопок сброса и сохранения
        ...
        // Настройки для вывода на окне выбора фракталов
    ...
    private void drawFractal() {
        ...
        for (int i = 0; i < size; i++) {
            FractalWorker fractalWorker = new FractalWorker(i);//вспомогательный лкасс для распараллеливания выполнения в фоновом потоке
